...
// Challenge
const latestLargeMovementValue = movements.findLast(
...
console.log(
  `Your latest large movement was ${Math.abs(
    latestLargeMovementValue
  )} was ${movements.length - latestLargeMovementIndex} movements ago`
);
